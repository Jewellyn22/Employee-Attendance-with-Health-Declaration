...
namespace ContractorAttendanceWithHealthDeclaration.Tests.Infrastructure
{
    ...
    public static class IntegrationSeed
    {
        ...
        public static async Task CreateContractorAsync(
            MySqlConnection connection,
            string employee_id = EmployeeId,
            string provider_code = ProviderCode,
            string name = "TST Contractor One",
        ...
        {
            await connection.ExecuteAsync(
                @"INSERT INTO contractor_employee
        ...
        {
            await connection.ExecuteAsync(
                @"INSERT INTO contractor_project (employee_id, project_code, position)
