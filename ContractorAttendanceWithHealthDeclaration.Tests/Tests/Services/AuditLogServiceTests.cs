...
namespace ContractorAttendanceWithHealthDeclaration.Tests.Services
{
    public class AuditLogServiceTests
    {
        ...
        public async Task Log_persists_an_entry_with_all_fields_set()
        {
            ...
            var result = await CreateService().Log("contractor", "create", "TST-000001", null, new { active = 1 }, "ADMIN-1");

            Assert.True(result.Success);
            Assert.NotNull(captured);
            Assert.Equal("contractor", captured!.entity_type);
        ...
        public async Task Log_serializes_payloads_as_indented_snake_case_json()
        {
            ...
            await CreateService().Log("contractor", "update", "TST-000001", payload, payload, "ADMIN-1");
        ...
        public async Task Log_blank_updated_by_is_recorded_as_system()
        {
            ...
            await CreateService().Log("contractor", "create", "TST-000001", null, null, "  ");
        ...
        public async Task Log_non_serializable_payload_fails_gracefully_instead_of_throwing()
        {
            ...
            var result = await CreateService().Log("contractor", "update", "TST-000001", cyclic, null, "ADMIN-1");
        ...
        public async Task Log_repository_failure_returns_failure_envelope_without_throwing()
        {
            ...
            var result = await CreateService().Log("contractor", "create", "TST-000001", null, null, "ADMIN-1");
        ...
        {
            var data = new[] { new audit_log { log_id = 1 } };
            _repository.GetByEntity("contractor", "deactivate_by_project").Returns(data);

            var result = await CreateService().GetByEntity("contractor", "deactivate_by_project");
        ...
        public async Task GetByEntity_repository_failure_returns_error_envelope()
        {
            ...
            var result = await CreateService().GetByEntity("contractor", "update");
