...
namespace EmployeeAttendanceWithHealthDeclaration.Tests.Infrastructure
{
    ...
    /// employee_attendance database from the output-copy of appsettings.json
    /// (override with the EMPLOYEEATT_TEST_CONNECTION_STRING environment variable).
    ///
    ...
    {
        private const string ConnectionStringEnvVar = "EMPLOYEEATT_TEST_CONNECTION_STRING";
