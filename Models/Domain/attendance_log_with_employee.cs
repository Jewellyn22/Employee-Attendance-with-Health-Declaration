namespace EmployeeAttendanceWithHealthDeclaration.Models.Domain
{
    public class attendance_log_with_employee
    {
        ...
        public string name { get; set; }          // From employee
        public string provider_code { get; set; }  // From employee
        public string provider_name { get; set; }  // From providers table
        public string project_code { get; set; }   // CSV via employee_project (multi-project)
        public string project_name { get; set; }   // CSV via employee_project (multi-project)
